...
shoppers.forEach(function(shopper){
    if(shopper.amount >= 200){
        console.log(shopper.name+", $"+shopper.amount+", $"+(shopper.amount*0.12).toFixed(2)+", $"+(shopper.amount*0.88).toFixed(2))
    }else {
...
books.forEach(function(bookEle,index){
    showBookInfo(bookEle,index);
});
...
//     console.log("Book # "+(book.indexof()+1));
//     console.log("Title: "+book.title);
//     console.log("Author: "+(book.author.first+" "+book.author.last));
//     console.log("---");
// };
